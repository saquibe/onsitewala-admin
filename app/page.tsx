...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState('admin@saascraft.in');
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 brand-gradient relative overflow-hidden">
        <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(circle at 20% 30%, white 1px, transparent 1px), radial-gradient(circle at 80% 70%, white 1px, transparent 1px)', backgroundSize: '50px 50px' }} />
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-white/60">by SaaScraft Studio</div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/70 text-lg max-w-md">
              Badges, certificates, scanning and attendee data — all in one elegant admin panel built for event organizers.
            </p>
          ...
          <div className="text-xs text-white/40">© 2025 SaaScraft Studio. All rights reserved.</div>
        </div>
      </div>
